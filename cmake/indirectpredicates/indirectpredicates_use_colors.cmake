...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(INDIRECTPREDICATES_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  indirectpredicates_filter_flags(INDIRECTPREDICATES_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${INDIRECTPREDICATES_GLOBAL_FLAGS}")
  add_compile_options(${INDIRECTPREDICATES_GLOBAL_FLAGS})
endif()
