...
if(TARGET indirectpredicates::warnings)
    return()
endif()
...
add_library(indirectpredicates_warnings INTERFACE)
add_library(indirectpredicates::warnings ALIAS indirectpredicates_warnings)

include(indirectpredicates_filter_flags)
indirectpredicates_filter_flags(PARAVIEWO_WARNING_FLAGS)
target_compile_options(indirectpredicates_warnings INTERFACE ${PARAVIEWO_WARNING_FLAGS})